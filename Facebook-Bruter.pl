...
# Tool: Adij Bruter
# Author: Anhar khan
# Contact: www.facebook.com/anhar.alman.1
# Code date: 10 sep 2016
# 
#
# Description:
# Adij Cracker is a password cracking tool written in perl to perform a dictionary-based attack on a specific Facebook user through HTTPS.
#
# Usage:
# perl Adij-Bruter.pl login wordlist
...
#
# Demo:
# perl Adij-Bruter.pl Facebooklogin@facebook.com wordlist.lst 
#
# --- Adij-Bruter Facebook password cracking tool
# --- By Anhar Khan
# --- www.facebook.com/anhar.alman.1
#
...
print "\n+++
    ...
    |  _  | /'_` || |    | |   |  _ <'( '__)( ) ( )| |   /'__`\( '__)
    | | | |( (_| || |    | |   | (_) )| |   | (_) || |_ (  ___/| |   
    (_) (_)`\__,_)(_) _  | |   (____/'(_)   `\___/'`\__)`\____)(_)   
                     ( )_| |                                         
                     `\___/'                                         


\n";
print "+++ Coded by AnhaR Khan\n";
print "+++ www.fb.com/anhar.alman.1\n\n";
